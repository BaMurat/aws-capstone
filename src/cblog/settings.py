...
DATABASES = {
    'default': {
        ...
        'NAME': 'db1', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'blog-rds.c5z2vshp1m6n.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blog-ws' # please enter your s3 bucket name
